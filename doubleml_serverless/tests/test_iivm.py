...
def dml_iivm_fixture(generate_data_iivm, idx, learner, score, dml_procedure, trimming_threshold):
    ...
    dml_iivm_lambda = DoubleMLIIVMServerlessLocal('local', 'local',
                                                  dml_data_json,
                                                  ml_g, ml_m, ml_r,
                                                  n_folds,
                                                  score=score,
...
def dml_iivm_scaling_fixture(generate_data_iivm, idx, learner, score, dml_procedure):
    ...
    np.random.seed(3141)
    dml_iivm_folds = DoubleMLIIVMServerlessLocal('local', 'local',
                                                 dml_data_json,
                                                 ml_g, ml_m, ml_r,
                                                 n_folds,
                                                 score=score,
    ...
    np.random.seed(3141)
    dml_iivm_reps = DoubleMLIIVMServerlessLocal('local', 'local',
                                                dml_data_json,
                                                ml_g, ml_m, ml_r,
                                                n_folds,
                                                score=score,
