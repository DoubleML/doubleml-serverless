...
def dml_pliv_fixture(generate_data_pliv, idx, learner, score, dml_procedure):
    ...
    dml_pliv_lambda = dml_lambda.DoubleMLPLIVServerless('local', 'local',
                                                        dml_data_json,
                                                        ml_g, ml_m, ml_r,
                                                        n_folds,
                                                        score=score,
...
def dml_pliv_scaling_fixture(generate_data_pliv, idx, learner, score, dml_procedure):
    ...
    np.random.seed(3141)
    dml_pliv_folds = dml_lambda.DoubleMLPLIVServerless('local', 'local',
                                                       dml_data_json,
                                                       ml_g, ml_m, ml_r,
                                                       n_folds,
                                                       score=score,
    ...
    dml_pliv_folds.fit('n_folds * n_rep')

    np.random.seed(3141)
    dml_pliv_reps = dml_lambda.DoubleMLPLIVServerless('local', 'local',
                                                      dml_data_json,
                                                      ml_g, ml_m, ml_r,
                                                      n_folds,
                                                      score=score,
